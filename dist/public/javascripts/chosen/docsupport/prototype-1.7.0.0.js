...
Element.Methods = {
  ...
  insert: function insert(element, insertions) {
    element = $(element);
  ...
  recursivelyCollect: function recursivelyCollect(element, property, maximumLength) {
    element = $(element);
  ...
  previousSiblings: function previousSiblings(element, maximumLength) {
  ...
  down: function down(element, expression, index) {
    element = $(element);
  ...
  readAttribute: function readAttribute(element, name) {
    element = $(element);
  ...
  writeAttribute: function writeAttribute(element, name, value) {
    ...
    if ((typeof name === 'undefined' ? 'undefined' : _typeof(name)) == 'object') attributes = name;else attributes[name] = Object.isUndefined(value) ? true : value;
  ...
  setStyle: function setStyle(element, styles) {
    ...
    for (var property in styles) {
      if (property == 'opacity') element.setOpacity(styles[property]);else elementStyle[property == 'float' || property == 'cssFloat' ? Object.isUndefined(elementStyle.styleFloat) ? 'cssFloat' : 'styleFloat' : property] = styles[property];
    }return element;
  },
  ...
  clonePosition: function clonePosition(element, source) {
  ...
  Element._attributeTranslations = function () {
    ...
    return {
      read: {
        ...
        values: {
          _getAttr: function _getAttr(element, attribute) {
            return element.getAttribute(attribute);
          },
          _getAttr2: function _getAttr2(element, attribute) {
            return element.getAttribute(attribute, 2);
          },
          _getAttrNode: function _getAttrNode(element, attribute) {
          ...
          _getEv: function () {
            ...
            if (String(value).indexOf('{') > -1) {
              f = function f(element, attribute) {
          ...
          _flag: function _flag(element, attribute) {
...
Element.Methods.Simulated = {
  hasAttribute: function hasAttribute(element, attribute) {
...
Element.addMethods({
  getStorage: function getStorage(element) {
    if (!(element = $(element))) return;
...
(function () {
  ...
  var Sizzle = function (_Sizzle) {
    function Sizzle(_x, _x2, _x3, _x4) {
      return _Sizzle.apply(this, arguments);
    }

    Sizzle.toString = function () {
      return _Sizzle.toString();
    };
  ...
  if (document.querySelectorAll) (function () {
    ...
    Sizzle = function Sizzle(query, context, extra, seed) {
...
var Form = {
  ...
  serializeElements: function serializeElements(elements, options) {
    if ((typeof options === 'undefined' ? 'undefined' : _typeof(options)) != 'object') options = { hash: !!options };else if (Object.isUndefined(options.hash)) options.hash = true;
    var key,
        value,
        submitted = false,
...
(function () {
  ...
  function _createResponder(element, eventName, handler) {
    ...
    if (eventName.include(":")) {
      responder = function responder(event) {
  ...
  if (!MOUSEENTER_MOUSELEAVE_EVENTS_SUPPORTED) {
    _getDOMEventName = function _getDOMEventName(eventName) {
  ...
  function observe(element, eventName, handler) {
    ...
    if (eventName.include(':')) {
      if (element.addEventListener) element.addEventListener("dataavailable", responder, false);else {
      ...
      if (element.addEventListener) element.addEventListener(actualEventName, responder, false);else element.attachEvent("on" + actualEventName, responder);
    }
  ...
  function stopObserving(element, eventName, handler) {
    ...
    if (eventName.include(':')) {
      if (element.removeEventListener) element.removeEventListener("dataavailable", responder, false);else {
        element.detachEvent("ondataavailable", responder);
        element.detachEvent("onlosecapture", responder);
      }
    } else {
      var actualEventName = _getDOMEventName(eventName);
      if (element.removeEventListener) element.removeEventListener(actualEventName, responder, false);else element.detachEvent('on' + actualEventName, responder);
    }
